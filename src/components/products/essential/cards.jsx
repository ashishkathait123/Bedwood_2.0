...
const EssentialsSection = () => {
  const essentials = [
    { image: '/homefurniture/1.jpg', title: 'Computer Desk', description: 'Comfortable Computer Desk', link: '/products?subcategory=Single+Bed&sort=1' },
    ...
    { image: '/homefurniture/6.jpg', title: 'Modern Sofa', description: 'Comfortable modern sofa for your living room', link: '/products?subcategory=Modern+Sofa&sort=1' },
